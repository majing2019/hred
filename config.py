...
from husky.chat.generated.utils.env import is_dev_env

MODEL_NAME = 'husky_chat_generated_v2.0_keras_tf'
...
# train datasets
DATA_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), '../../data/chat/generated')
...
RESULTS_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), '../../data/chat/generated')  # Directory to store training results
